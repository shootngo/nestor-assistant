...
- [Hatch — official splash (cracked egg)](./docs/phase-3-hatch-nest.png)
- [Hatch — Home, held gently](./docs/phase-3-hatch-egg.png)
- [Hatch — shell fragments](./docs/phase-3-hatch-open.png)
- [Hatch — serif Nestor + greeting](./docs/phase-3-hatch-house.png)
