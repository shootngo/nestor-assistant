...
- Night answers are **quieter** (TTS volume is scaled down). The warmer Google / high-quality voice pick does not change that. **Mute** still silences him completely. **–** / **+** still change the tablet media stream.
